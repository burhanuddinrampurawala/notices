...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private boolean check(){
        ...
        if(password.length() == 0){
            mPasswordView.setError("feild required");
            focusView[0] = mPasswordView;
            cancel = true;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.w("niotice", "signInWithEmail:failure", task.getException());
                            showProgress(false);
                        }
                    }
                });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(), "The email address is already in use by another account",
